<div class="flex flex-col bg-white p-10 rounded-3xl shadow-2xl shadow-gray-600/50 max-w-screen-lg mx-auto my-8 space-y-auto">
    <!-- Título e Informações da Empresa -->
    <div class="bg-gradient-to-r from-blue-800 to-blue-600 text-white p-8 rounded-3xl shadow-xl shadow-blue-800/50">
    ...
    <!-- Usuários da Empresa -->
    <div class="bg-gray-50 p-8 rounded-3xl mt-10">
