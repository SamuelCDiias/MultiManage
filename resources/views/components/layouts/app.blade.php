        ...
        <div class="flex min-h-screen bg-gray-100 dark:bg-gray-900">
            ...
            <aside class="w-64 bg-blue-800 text-white flex flex-col fixed h-full">
                ...
                <nav class="flex-1 px-4 py-6 space-y-4">
                    <a href="{{route('company.dashboard')}}" class="flex items-center px-4 py-2 rounded-lg hover:bg-blue-700 transition" wire:navigate>
                    ...
                    <a href="{{ route('companies.show') }}" class="flex items-center px-4 py-2 rounded-lg hover:bg-blue-700 transition">
                        <svg class="w-5 h-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 10h16M10 14h6" />
                        </svg>
                        Empresas
                    </a>
                    <a href="#" class="flex items-center px-4 py-2 rounded-lg hover:bg-blue-700 transition" wire:navigate>
                        <svg class="w-5 h-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div class="p-4 border-t border-blue-700">
                    <form method="POST" action="#">
                        @csrf
                        <button type="submit" class="w-full bg-red-500 px-4 py-2 text-white rounded-lg hover:bg-red-600 transition duration-200">
                            Sair
                        </button>
                    </form>
                </div>
